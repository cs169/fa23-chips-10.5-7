  ...
  describe '.civic_api_to_representative_params' do
    it 'creates representatives without errors for duplicate input' do
      rep_info = instance_double(rep_info,
         ...
         address: [instance_double(address, locationName: '123 Flame Ave', line1: 'Apt 1',
                                    line2: '', line3: '', city: 'Perris', state: 'CA', zip: '12345')],
                                    party: 'Party', photoUrl: 'url'),
                                   instance_double(official, name: 'Hannah Smith',
         address: [instance_double(address, locationName: '123 Flame Ave',
         line1: 'Apt 1', line2: '', line3: '', city: 'Perris',
         state: 'CA', zip: '12345')], party: 'Party', photoUrl: 'url')
                                 ],
                                 offices:   [
